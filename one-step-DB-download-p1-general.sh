...
mkdir cazy
cd cazy
aria2c -i $1/DB_links/link_cazy.txt
cd ../
...
mkdir cog
cd cog
aria2c -i $1/DB_links/link_cog.txt
cd ../
...
mkdir tcdb
cd tcdb
aria2c -i $1/DB_links/link_tcdb.txt
cd ../
...
mkdir merops
cd merops
aria2c -i $1/DB_links/link_merops.txt
cd ../
...
mkdir swissprot
cd swissprot
aria2c -i $1/DB_links/link_swissprot.txt
cd ../
...
mkdir pfam-A
cd pfam-A
aria2c -i $1/DB_links/link_pfam-A.txt
cd ../
...
cd UniProtKB-TrEMBL
aria2c -i $1/DB_links/link_UniProtKB-TrEMBL.txt
cd ../
