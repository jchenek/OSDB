...
cd gene_seq
cp ../all_genes.list ./
cat all_genes.list | while read id; do wget -nc http://rest.kegg.jp/get/$id/aaseq -O ${id//:/_} --referer='http://css-tricks.com/forums/topic/font-face-in-base64-is-cross-browser-compatible/' -U 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_4) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/11.1 Safari/605.1.15'; done
rm all_genes.list
