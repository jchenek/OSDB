...
foreach my$file (@filelist) {
	...
	print OU2"diamond blastp --db $path\/swissprot/*.dmnd --query $dir\/$file --out ./diamond_out/swissprot/$file_name.swissprot.m6out --outfmt 6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qcovhsp scovhsp --sensitive -k 1 -e 1e-20 -c1 --query-cover 70 --subject-cover 70 --id 40\n";
	print OU2 "mkdir diamond_out/cazy\n";
	print OU2 "diamond blastp --db $path\/cazy/*.dmnd --query $dir\/$file --out ./diamond_out/cazy/$file_name.cazy.m6out --outfmt 6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qcovhsp scovhsp --sensitive -k 1 -e 1e-20 -c1 --query-cover 70 --subject-cover 70 --id 40\n";
	print OU2 "mkdir diamond_out/cog\n";
	print OU2 "diamond blastp --db $path\/cog/*.dmnd --query $dir\/$file --out ./diamond_out/cog/$file_name.cog.m6out --outfmt 6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qcovhsp scovhsp --sensitive -k 1 -e 1e-20 -c1 --query-cover 70 --subject-cover 70 --id 40\n";
	...
	print OU2 "diamond blastp --db $path\/kegg/*.dmnd --query $dir\/$file --out ./diamond_out/kegg/$file_name.kegg.m6out --outfmt 6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qcovhsp scovhsp --sensitive -k 1 -e 1e-20 -c1 --query-cover 70 --subject-cover 70 --id 40\n";
	}
	}
